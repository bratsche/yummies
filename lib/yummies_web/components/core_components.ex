defmodule YummiesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(YummiesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(YummiesWeb.Gettext, "errors", msg, opts)
    end
  end
